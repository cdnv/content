...
<div class="rwp-pros-wrap">
    ...
    <span
        ...
        style="color: <?php $this->template_field('template_pros_label_color') ?>;
               ...
               line-height: <?php $this->template_field('template_pros_label_font_size') ?>px;"><?php _e($this->template_field('template_pros_label', true), 'reviewer') ?></span>
...
<div class="rwp-cons-wrap">
    ...
    <span
        ...
        style="color: <?php $this->template_field('template_cons_label_color') ?>;
               ...
               line-height: <?php $this->template_field('template_cons_label_font_size') ?>px;"><?php _e($this->template_field('template_cons_label', true), 'reviewer') ?></span>
